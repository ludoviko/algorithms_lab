...
public abstract class SortAbstractIntegerTest {
	ArraySortAbstract<Integer> sort;
	Integer[] array;

	public abstract ArraySortAbstract<Integer> create();
	...
	public void testFindMimimum() {
		...
		int minimum = ArraySortAbstract.findMinimumIndex(this.array, 0);
	...
	public void testFindMimimum2() {
		...
		int minimum = ArraySortAbstract.findMinimumIndex(this.array, 1);
		Assert.assertEquals(minimum, 1);

		minimum = ArraySortAbstract.findMinimumIndex(this.array, 2);
